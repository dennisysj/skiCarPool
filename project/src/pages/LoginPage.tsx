...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simulated login - just stores in localStorage
      ...
      setTimeout(() => {
        // Use window.location for a full page reload to ensure everything refreshes
  ...
  const handleSocialLogin = async (provider: Provider) => {
    try {
      ...
      console.log(`${provider} login successful, navigating to home page`);
